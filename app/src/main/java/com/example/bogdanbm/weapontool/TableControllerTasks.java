...
public class TableControllerTasks extends DatabaseHandler {
    ...
    public int count(int weaponId) {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "SELECT * FROM tasks WHERE weaponID = " + weaponId;
    ...
    public boolean create(ObjectTask task) {
        ...
        values.put("weaponID", task.weaponId);
    ...
    public ObjectTask readByID(int id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int weaponId = Integer.parseInt(cursor.getString(cursor.getColumnIndex("weaponID")));

            objectTask= new ObjectTask();
            objectTask.id = taskId;
            objectTask.description = description;
            objectTask.weaponId = weaponId;
        }
    ...
    public List<ObjectTask> read(int weaponId) {

        List<ObjectTask> recordsList = new ArrayList<ObjectTask>();

        String sql = "SELECT * FROM tasks WHERE weaponID = " + weaponId + " ORDER BY description";
